...
| [google-drive-organiser](./google-drive-organiser/) | Organise and clean up Google Drive via the Google Drive MCP server | **Commands:** `/gdrive-organise` - Sort loose files into type-based folders, `/gdrive-clean` - Detect duplicates and flag large/old files, `/gdrive-audit` - Analyse folder structure and get improvement suggestions<br>**Agents:** `drive-analyser`, `drive-organiser` |
